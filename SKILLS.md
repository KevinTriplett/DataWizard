...
| **session-closer** (v1.9) | Technique | Writing the session log entry at the end of every session. Includes Learnings section and handoff-quality "What's next." The session log IS the handoff. Periodic nudges for health audit (10 sessions), meta-learning review (5-10 sessions), and Content Interests staleness (30 days / 10 sessions). |
